...
public class DetailActivity extends Activity implements View.OnClickListener {
  ...
  private PlayPauseButton mAddButton;
  private LinearLayout linearAddButton;
  private ImageButton mLastButton,mNxtButton;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mAddButton = (PlayPauseButton) findViewById(R.id.btn_add);
    linearAddButton = (LinearLayout) findViewById(R.id.linear);
    mLastButton = (ImageButton) findViewById(R.id.btn_last);
    mNxtButton = (ImageButton) findViewById(R.id.btn_nxt);
    ...
    mLastButton.setImageResource(R.drawable.previuos);
    mLastButton.setOnClickListener(this);
    mNxtButton.setImageResource(R.drawable.next);
    mNxtButton.setOnClickListener(this);
    ...
    mAdapter = new SongsListAdapter(this);
  ...
  private void windowTransition() {
    ...
    getWindow().getEnterTransition().addListener(new TransitionAdapter() {
      ...
      public void onTransitionEnd(Transition transition) {
        linearAddButton.animate().alpha(1.0f);
        mAddButton.animate().alpha(1.0f);
        mLastButton.animate().alpha(1.0f);
        mNxtButton.animate().alpha(1.0f);
  ...
  private void applyPalette() {
    ...
    applyRippleColor(mPalette.getVibrantColor(defaultColorForRipple),
            mPalette.getDarkVibrantColor(defaultColorForRipple),1);
    mRevealView.setBackgroundColor(mPalette.getLightVibrantColor(defaultColorForRipple));
  }

  private void applyRippleColor(int bgColor, int tintColor,int btton) {
    switch (btton){
      case 0:
        colorRipple(mLastButton, bgColor, tintColor);
        break;
      case 1:
        colorRipple(linearAddButton, bgColor, tintColor);
        break;
      case 2:
        colorRipple(mNxtButton, bgColor, tintColor);
        break;
    }
  }

  private void colorRipple(View id, int bgColor, int tintColor) {
    View buttonView = id;
    ...
    switch (v.getId()) {
      case R.id.btn_add:
        if (!isEditTextVisible) {
         ...
         // mAnimatable.start();
          applyRippleColor(getResources().getColor(R.color.light_green), getResources().getColor(R.color.dark_green),1);
        } else {
      ...
      case R.id.btn_last:
        if (!isEditTextVisible) {
          ...
          mInputManager.showSoftInput(mEditTextTodo, InputMethodManager.SHOW_IMPLICIT);
          //mLastButton.setImageResource(R.drawable.previuos);
         //mAnimatable = (Animatable) (mLastButton).getDrawable();
         // mAnimatable.start();
          applyRippleColor(getResources().getColor(R.color.light_green), getResources().getColor(R.color.dark_green),0);
        } else {
          addToDo(mEditTextTodo.getText().toString());
          mToDoAdapter.notifyDataSetChanged();
          mInputManager.hideSoftInputFromWindow(mEditTextTodo.getWindowToken(), 0);
         ...
         // mAnimatable = (Animatable) (mLastButton).getDrawable();
          //mAnimatable.start();
          applyRippleColor(mPalette.getVibrantColor(defaultColorForRipple),
                  mPalette.getDarkVibrantColor(defaultColorForRipple),0);
        }
        break;
      case R.id.btn_nxt:
        if (!isEditTextVisible) {
          ...
          mInputManager.showSoftInput(mEditTextTodo, InputMethodManager.SHOW_IMPLICIT);
          //mNxtButton.setImageResource(R.drawable.next);
          //mAnimatable = (Animatable) (mNxtButton).getDrawable();
          //mAnimatable.start();
          applyRippleColor(getResources().getColor(R.color.light_green), getResources().getColor(R.color.dark_green),2);
        } else {
          addToDo(mEditTextTodo.getText().toString());
          mToDoAdapter.notifyDataSetChanged();
          mInputManager.hideSoftInputFromWindow(mEditTextTodo.getWindowToken(), 0);
          ...
          //mAnimatable.start();
          applyRippleColor(mPalette.getVibrantColor(defaultColorForRipple),
                  mPalette.getDarkVibrantColor(defaultColorForRipple),2);
        }
        break;
    }
  }
  ...
  public void onBackPressed() {
    ...
    linearAddButton.startAnimation(alphaAnimation);
    mAddButton.startAnimation(alphaAnimation);
    mLastButton.startAnimation(alphaAnimation);
    mNxtButton.startAnimation(alphaAnimation);
    alphaAnimation.setAnimationListener(new Animation.AnimationListener() {
      ...
      public void onAnimationEnd(Animation animation) {
        linearAddButton.setVisibility(View.GONE);
        mAddButton.setVisibility(View.GONE);
        mLastButton.setVisibility(View.GONE);
        mNxtButton.setVisibility(View.GONE);
