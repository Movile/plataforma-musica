...
import java.lang.Override;import java.net.MalformedURLException;
import java.net.URL;import bhouse.travellist.R;
...
public class TravelListAdapter extends RecyclerView.Adapter<TravelListAdapter.ViewHolder> {
  ...
  public void onBindViewHolder(final ViewHolder holder, final int position) {
    ...
    //Picasso.with(mContext).load("http://www.efeeme.com/wp-content/uploads/molotov-22-03-14.jpg").into(holder.placeImage);
    Picasso.with(mContext)
            .load("http://www.efeeme.com/wp-content/uploads/molotov-22-03-14.jpg")
            .config(Bitmap.Config.RGB_565)
            .error(place.getImageResourceId(mContext))
            .fit()
            .centerInside()
